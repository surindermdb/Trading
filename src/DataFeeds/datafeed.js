...
export default {
	...
	resolveSymbol: async (
		...
		const symbols = await getAllExchangeSymbols(symbolName);
		...
		const symbolInfo = {
			...
			supported_resolutions: ['1', '5', '15', '60', '240', '1D', '1W','1M'],//configurationData.supported_resolutions,
			volume_precision: 0,
	...
	getBars: async (symbolInfo, resolution, periodParams, onHistoryCallback, onErrorCallback) => {
		...
		try {
			...
			let klinedata = await getRequest(APIURL + 'kline?address=', pairAddress);
			let bars = [];
